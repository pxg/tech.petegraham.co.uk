...
Please use the Shadowbox JS [support forum](http://forum.sivel.net/viewforum.php?id=4) for problems or questions with this plugin. Support questions will be ignored if left in the WordPress.org support forums, as comments on my site, through my contact form or by email. The only supported location for support questions is [http://forum.sivel.net/](http://forum.sivel.net). 
